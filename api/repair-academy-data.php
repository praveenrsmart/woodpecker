 ...
 * Upload to /wood/api/, open in browser once, then DELETE this file.
 *
 * URL: https://chesstrackers.com/wood/api/repair-academy-data.php
 */
...
<body>
  ...
  <p class="warn">Delete this file (api/repair-academy-data.php) when done.</p>
</body>
</html>
